                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ route('admin.koleksi.edit', $item->id) }}" class="text-blue-600 hover:text-blue-800 text-xs font-semibold flex items-center gap-1" title="Edit">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        Edit
                                    </a>
                                    <form action="{{ route('admin.koleksi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini beserta seluruh datanya?');" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="text-red-600 hover:text-red-800 text-xs font-semibold flex items-center gap-1" title="Hapus">
