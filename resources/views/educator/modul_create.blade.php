    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-[#fdfbf9] border border-[#f2ebe3] rounded-xl shadow-sm overflow-hidden">
                <div class="bg-white border-b border-[#f2ebe3] p-6">
                ...
                <form action="{{ route('educator.modul.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="flex gap-4 mt-3">
                            <div class="flex-1">
                                ...
                                <input type="text" id="latitude" name="latitude" readonly class="w-full mt-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded text-sm text-gray-600">
                            </div>
                            <div class="flex-1">
                                <label class="text-[10px] text-gray-500 uppercase font-bold">Longitude</label>
                                <input type="text" id="longitude" name="longitude" readonly class="w-full mt-1 px-3 py-2 bg-gray-50 border border-gray-200 rounded text-sm text-gray-600">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-[#f2ebe3] bg-[#fdfbf9] -mx-8 -mb-8 px-8 py-4">
                        ...
                        <button type="submit" class="px-8 py-2.5 bg-[#4a1b1b] text-white text-sm font-semibold rounded shadow-sm hover:bg-[#381111] transition">
                            Publis
                        </button>
                    </div>
                </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const defaultLat = 3.13220; // Museum Pusaka Karo
        const defaultLng = 98.46650;
        
        const map = L.map('locationMap').setView([defaultLat, defaultLng], 12);
