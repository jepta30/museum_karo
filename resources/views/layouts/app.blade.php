        ...
        <div>
            ...
            <nav class="px-4 mt-2">
                @if(Auth::user()->peran === 'admin')
                    ...
                    <a href="{{ route('admin.koleksi.laporan') }}" class="flex items-center gap-3 px-4 py-2.5 mt-1 text-sm font-medium rounded-md {{ request()->routeIs('admin.koleksi.laporan') ? 'bg-white/20 text-white shadow-inner font-bold border-l-4 border-white' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-6h6v6m2 4H7a2 2 0 01-2-2V7a2 2 0 012-2h10a2 2 0 012 2v12a2 2 0 01-2 2z"/></svg>
                        Laporan Koleksi
                    </a>
                    <a href="{{ route('admin.laporan.komentar') }}" class="flex items-center gap-3 px-4 py-2.5 mt-1 text-sm font-medium rounded-md {{ request()->routeIs('admin.laporan.komentar') ? 'bg-white/20 text-white shadow-inner font-bold border-l-4 border-white' : 'text-white/80 hover:bg-white/10 hover:text-white' }}">
